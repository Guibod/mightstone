...
class Identifiers(MightstoneModel):
    ...
    mtgjson_foil_version_id: Optional[str] = Field(
        since="v5.2.1", alias="mtgjsonFoilVersionId"
    )
    ...
    mtgjson_non_foil_version_id: Optional[str] = Field(
        since="v5.2.1", alias="mtgjsonNonFoilVersionId"
    )
...
class Legalities(MightstoneModel):
    ...
    explorer: Optional[str] = Field(since="v5.2.1", alias="explorer")
    ...
    predh: Optional[str] = Field(since="v5.2.1", alias="predh")
...
class RelatedCards(MightstoneModel):
    reverse_related: Optional[List[str]] = Field(since="v5.2.1", alias="reverseRelated")
    """A list of card names associated to a card, such as "meld" cards and token 
    creation."""

    spellbook: Optional[List[str]] = Field(since="v5.2.1", alias="spellbook")
...
class SealedProduct(MightstoneModel):
    category: Optional[str] = Field(since="v5.2.1", alias="category")
    ...
    product_size: Optional[int] = Field(since="v5.2.1", alias="productSize")
    ...
    subtype: Optional[str] = Field(since="v5.2.1", alias="subtype")
...
class CardFace(MightstoneModel):
    ...
    attraction_lights: Optional[List[str]] = Field(
        since="v5.2.1", alias="attractionLights"
    )
    ...
    defense: Optional[str] = Field(since="v5.2.1", alias="defense")
    ...
    edhrec_saltiness: Optional[float] = Field(since="v5.2.1", alias="edhrecSaltiness")
    ...
    first_printing: Optional[str] = Field(since="v5.2.1", alias="firstPrinting")
    """The set code the card was first printed in."""

    foreign_data: List[ForeignData] = Field(since="v5.2.1", alias="foreignData")
    ...
    is_funny: Optional[bool] = Field(since="v5.2.1", alias="isFunny")
    ...
    related_cards: Optional[RelatedCards] = Field(since="v5.2.1", alias="RelatedCards")

    rulings: Optional[List[Rulings]] = Field(since="v4.0.0", alias="rulings")
    ...
    subsets: Optional[List[str]] = Field(since="v4.0.0", alias="subsets")
...
class CardDeck(MightstoneModel):
    ...
    is_starter: Optional[bool] = Field(
        since="v4.0.0", alias="isStarter", deprecated=True
    )
    ...
    related_cards: Optional[RelatedCards] = Field(since="5.2.1", alias="RelatedCards")
    ...
    subsets: Optional[List[str]] = Field(since="v5.2.1", alias="subsets")
    """The names of the subset printings a card is in. Used primarily on "Secret Lair 
    Drop" cards."""
...
class CardSet(MtgJsonDocument):
    ...
    edhrec_saltiness: Optional[float] = Field(since="v4.5.0", alias="edhrecSaltiness")
    """The card saltiness score on EDHRec."""
...
class CardToken(MtgJsonDocument):
    ...
    orientation: Optional[str] = Field(since="v5.2.1", alias="orientation")
    ...
    related_cards: RelatedCards = Field(since="v5.2.1", alias="relatedCards")
    """The related cards for this card. See the Related Cards Data Model."""

    reverse_related: List[str] = Field(
        since="v4.0.0", alias="reverseRelated", deprecated="True"
    )
...
class Set(MtgJsonDocument):
    base_set_size: int = Field(since="v4.1.0", alias="baseSetSize")
    ...
    languages: List[str] = Field(since="v5.2.1", alias="languages")
    ...
    token_set_code: Optional[str] = Field(since="v5.2.1", alias="tokenSetcode")
